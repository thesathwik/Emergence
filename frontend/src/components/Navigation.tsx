...
const Navigation: React.FC = () => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-[99999] bg-white/80 backdrop-blur-md border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="flex justify-between items-center h-20">
          {/* Logo */}
          <div className="flex items-center">
            <Link to="/" className="flex items-center" onClick={closeMobileMenu}>
              <h1 className="text-2xl font-light text-gray-900 tracking-wide"> Emergence </h1>
            </Link>
          </div>
            ...
            <div className="ml-4 flex items-center md:ml-6">
              {isAuthenticated ? (
                <>
                  ...
                  {/* Profile dropdown */}
                  <div className="ml-3 relative z-[1001]" ref={userMenuRef}>
                    <div>
                      <button
                    ...
                    {showUserMenu && (
                      <div
                        ...
                        className="origin-top-right absolute right-0 mt-2 w-56 rounded-xl shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none z-[100000] border border-gray-100 pointer-events-auto"
                      >
                        <div className="py-1">
                          {/* User Info */}
          ...
          {navigationItems.map((item) => (
            <Link
              ...
              className={`flex items-center px-3 py-2 rounded-md text-base font-medium transition-colors ${
                isActive(item.path) ? 'bg-blue-100 text-blue-700' : 'text-gray-500 hover:text-gray-900 hover:bg-gray-100'
              }`}
            >
