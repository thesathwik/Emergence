              ...
              <MarkdownContent>
                ...
                <div className="text-center">
                  <a 
                    ...
                    download
                    className="inline-flex items-center justify-center px-6 py-3 bg-gray-900 text-white font-medium rounded-lg hover:bg-gray-800 transition-colors duration-200 no-underline"
                  >
              ...
              <MarkdownContent>
                ...
                <div className="text-center">
                  ...
                  <a 
                    href="/agent-boilerplate.zip" 
                    download
                    className="inline-flex items-center justify-center px-8 py-4 bg-gray-900 text-white font-medium rounded-xl hover:bg-gray-800 transition-colors duration-200 no-underline"
                  >
